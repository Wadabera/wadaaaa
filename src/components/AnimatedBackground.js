...
const AnimatedBackground = () => {
  ...
  return (
    ...
    >
      ...
      {/* Subtle grid with enhanced glow - hidden on mobile for performance */}
      <div className="absolute inset-0 bg-grid-faint [background-size:44px_44px] opacity-40 hidden sm:block" />
      ...
      {/* Reduced to 2 aurora blobs on mobile for performance */}
      ...
      {/* Enhanced floating geometric shapes - reduced on mobile */}
      {!isMobile && (
        <>
      ...
      {/* Subtle noise texture for depth - hidden on mobile */}
